...
| Defense Enabled | No |
| Attack Success | Yes |
| Channel Status | replayed |
| Channel Label | Replay Accepted |
| Defense Algorithm | None |
| Highest Current Alert | Critical: Duplicate payment request accepted |
...
| Nonce Checks | 00 | 00 | 01 | duplicate nonce blocked |
| Alert Priority | P1 | P1 | P2 | replay rejected |
